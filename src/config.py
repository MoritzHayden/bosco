BOSCO_USER_AGENT: str = 'discord:dev.boscobot'
BOSCO_WEBSITE_TEXT: str = 'Website'
BOSCO_WEBSITE_URL: str = 'https://boscobot.dev/'
BOSCO_INVITE_TEXT: str = 'Invite to Server'
BOSCO_INVITE_URL: str = 'https://discord.com/api/oauth2/authorize?client_id=1097476432579539026&permissions=2147568704&scope=bot'
